# Simple udata deployment with docker-compose

A sample docker-compose project with a minimalistic udata deployment.

It use the default configuration and a all-in-one container.

```bash
$ docker-compose up -d
Creating network "simple_default" with the default driver
Creating volume "simple_udata-fs" with default driver
Creating volume "simple_mongo-data" with default driver
Creating volume "simple_redis-data" with default driver
Creating volume "simple_elasticsearch-data" with default driver
Creating simple_redis_1
Creating simple_elasticsearch_1
Creating simple_mongodb_1
Creating simple_udata_1
